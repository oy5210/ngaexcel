	...
	statusMap ={
		...
		if(window.location.pathname == "/thread.php"){
			...
			for ( var i = 1; i < topics.length; i++) {
				...
				{
					ctx.push(topics[i].children[0].children[0].textContent);
					ctx.push(topics[i].children[0].children[2].children[0].textContent);
					ctx.push(topics[i].children[0].children[3].children[1].textContent);
					
					var threadCtx = topics[i].children[0].children[1].children,
